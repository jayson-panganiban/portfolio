      ...
      <div className='container px-4 mx-auto'>
        <div className='max-w-5xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10'>
            ...
            {/* Industry Experience */}
            <div>
              <div className='bg-slate-900 rounded-xl p-6 shadow-[8px_8px_16px_rgba(0,0,0,0.3),_-8px_-8px_16px_rgba(75,85,99,0.1)] border border-gray-700/50 transition-all duration-300 hover:shadow-[10px_10px_20px_rgba(0,0,0,0.4),_-10px_-10px_20px_rgba(75,85,99,0.15)] h-full'>
                ...
                <div className='space-y-2 sm:space-y-3 md:space-y-4'>
                  {resume.industryExperience.map((exp, index) => (
                    <div key={index}>
                      ...
                      <p className='text-gray-200 text-xs sm:text-xs md:text-sm pl-3 sm:pl-4'>
                        {exp.description}
                      </p>
                    </div>
                  ))}
