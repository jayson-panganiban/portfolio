          ...
          <div className='space-y-4 sm:space-y-6 md:space-y-10 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-1/2 before:h-full before:w-0.5 before:bg-emerald-400/30 '>
            {resume.workHistory.map((job, index) => (
              <div key={index} className='relative pl-6 md:pl-8'>
                ...
                <div className='bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-5 shadow-[8px_8px_16px_rgba(0,0,0,0.3),_-8px_-8px_16px_rgba(75,85,99,0.1)] border border-gray-700/30 transition-all duration-300 hover:shadow-[10px_10px_20px_rgba(0,0,0,0.4),_-10px_-10px_20px_rgba(75,85,99,0.15)]'>
